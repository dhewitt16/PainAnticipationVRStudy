...
% For figs with 6 subplots, drag to make full screen length (2x3) or full screen on half width (3x2) before saving.
% Save > .tif (no compression)
...
erdScale = [-30 30]; % scale for all maps - theta usually -30 30, alpha -20 20, beta -15 15
